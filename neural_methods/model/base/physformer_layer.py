"""
This file is the official PhysFormer implementation here: https://github.com/ZitongYu/PhysFormer
...
class MultiHeadedSelfAttention_TDC_gra_sharp(nn.Module):
    ...
    def __init__(self, dim, num_heads, dropout, theta):
        ...
        self.calv = nn.Conv2d(in_channels=4,out_channels=4,kernel_size=16,stride=16,padding=0)
        self.para = nn.Parameter(torch.ones(1)*1e-3)
